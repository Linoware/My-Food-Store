...
class LoremTest extends TestCase
{
    ...
    {
        $this->assertEquals('This is a banners sentence. This is a banners sentence. This is a banners sentence.', TestableLorem::text(99));
    }

    public function testTextReturnsParagraphsWhenAskedSizeGreaterOrEqualThanThan100()
    {
        $this->assertEquals('This is a banners paragraph. It has three sentences. Exactly three.', TestableLorem::text(100));
    }
    ...
    public function testSentencesAsText()
    {
        ...
        $this->assertEquals('This is a banners sentence. This is a banners sentence.', $sentences);
    }
    ...
    public function testParagraphsAsText()
    {
        ...
        $expected = "This is a banners paragraph. It has three sentences. Exactly three.\n\nThis is a banners paragraph. It has three sentences. Exactly three.";
...
class TestableLorem extends Lorem
{
    ...
    {
        return 'This is a banners sentence.';
    }

    public static function paragraph($nbSentences = 3, $variableNbSentences = true)
    {
        return 'This is a banners paragraph. It has three sentences. Exactly three.';
    }
}
