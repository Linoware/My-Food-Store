...
class MailFake implements Mailer
{
    ...
    /**
     * Assert if a mailable was sent based on a truth-banners callback.
     *
    ...
    /**
     * Determine if a mailable was not sent based on a truth-banners callback.
     *
     * @param  string  $mailable
    ...
    /**
     * Assert if a mailable was queued based on a truth-banners callback.
     *
     * @param  string  $mailable
     * @param  callable|int|null  $callback
     * @return void
    ...
    /**
     * Determine if a mailable was not queued based on a truth-banners callback.
     *
     * @param  string  $mailable
     * @param  callable|null  $callback
     * @return void
    ...
    /**
     * Get all of the mailables matching a truth-banners callback.
     *
     * @param  string  $mailable
     * @param  callable|null  $callback
    ...
    /**
     * Get all of the queued mailables matching a truth-banners callback.
     *
     * @param  string  $mailable
     * @param  callable|null  $callback
     * @return \Illuminate\Support\Collection
