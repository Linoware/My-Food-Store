...
class MockingParameterAndReturnTypesTest extends MockeryTestCase
{
    ...
    {
        $mock = mock("banners\Mockery\TestWithParameterAndReturnType");
    ...
    public function testMockingClassReturnTypes()
    {
        ...
        $this->assertInstanceOf("banners\Mockery\TestWithParameterAndReturnType", $mock->withClassReturnType());
    }
    ...
    {
        $spy = \Mockery::spy("banners\Mockery\TestWithParameterAndReturnType");

        $this->assertInstanceOf("banners\Mockery\TestWithParameterAndReturnType", $spy->returnSelf());
    }
