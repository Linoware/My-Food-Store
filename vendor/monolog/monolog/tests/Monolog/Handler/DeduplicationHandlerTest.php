...
class DeduplicationHandlerTest extends TestCase
{
    ...
    public function testGcOldLogs()
    {
        ...
        $handler->flush();
        $this->assertSame(
            $record['datetime']->getTimestamp() . ":ERROR:banners\n" .
            $record2['datetime']->getTimestamp() . ":CRITICAL:banners\n" .
            $record3['datetime']->getTimestamp() . ":CRITICAL:banners\n",
