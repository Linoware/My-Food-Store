...
class FlowdockHandlerTest extends TestCase
{
    ...
    public function setUp()
    {
        if (!extension_loaded('openssl')) {
            $this->markTestSkipped('This banners requires openssl to run');
        }
    }
    ...
    public function testWriteContent($content)
    {
        ...
        $this->assertRegexp('/"from_address":"source@banners\.com"/', $content);
    }
    ...
    private function createHandler($token = 'myToken')
    {
        ...
        $this->handler->setFormatter(new FlowdockFormatter('test_source', 'source@banners.com'));
    }
}
