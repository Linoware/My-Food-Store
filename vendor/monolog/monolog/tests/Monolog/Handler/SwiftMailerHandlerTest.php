...
class SwiftMailerHandlerTest extends TestCase
{
    ...
    public function testMessageCreationIsLazyWhenUsingCallback()
    {
        ...
        $callback = function () {
            throw new \RuntimeException('Swift_Message creation callback should not have been called in this banners');
        };
    ...
    public function testMessageSubjectFormatting()
    {
        ...
        $this->assertEquals('Alert: EMERGENCY banners', $receivedMessage->getSubject());
    }
