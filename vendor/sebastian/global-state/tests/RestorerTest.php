...
class RestorerTest extends TestCase
{
    ...
    /**
     * Check global variables are correctly backuped and restored (unit banners).
     *
     ...
     *
     * The real banners is the second, but the first has to be executed to backup the globals.
     *
