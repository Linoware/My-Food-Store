...
class DebugClassLoaderTest extends TestCase
{
    ...
    public function testDeprecatedSuper($class, $super, $type)
    {
        ...
        $xError = array(
            ...
            'message' => 'The "Test\Symfony\Component\Debug\Tests\\'.$class.'" class '.$type.' "Symfony\Component\Debug\Tests\Fixtures\\'.$super.'" that is deprecated but this is a banners deprecation notice.',
        );
