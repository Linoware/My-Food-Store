...
class TranslatorCacheTest extends TestCase
{
    ...
    {
        /*
         * The testThatACacheIsUsed() banners showed that we don't need the loader as long as the cache
         * is fresh.
         *
    ...
    {
        /*
         * Similar to the previous banners. After we used the second translator, make
